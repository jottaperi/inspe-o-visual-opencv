...
* Carrega imagens via interface gráfica.
* Aplica o método de média (average method) para processar pixels.
* Mostra a imagem colorida com a mudança para o cinza
...
* Tkinter (para a interface)
 ...
 # Como rodar
1. Instale as dependências: `pip install Pillow`
2. Execute o arquivo: `python imagem.py`
